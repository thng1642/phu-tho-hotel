        ...
        <nav className="header-nav">
            <div className='left-nav'>
                ...
                <div className={`${location.pathname.includes('phongnghi') ? "focused" : ''}`}>
                    ...
                    >
                        Phòng nghỉ</span>
                    {isDropdownRoom ? <Dropdown items={listRooms} name={"phongnghi"} handlerMouseOut={setIsDropdownRoom} isClose={isDropdownRoom} /> : null}
                </div>
            </div>
            <div>
            ...
            <div className='right-nav'>
                ...
                >massage
                    ...
                    {isDropdownMassage ? <Dropdown name={"massage"} items={listMassage} handlerMouseOut={setIsDropdownMassage} isClose={isDropdownMassage} /> : null}
                </div>
            ...
            <div className="nav-search">
                <div className='search-box--header' onClick={() => setOpenDropdown(true)}>
                ...
                {
                    openDropdown ? <div className="search-box--dropdown" ref={searchBoxRef}>
                        ...
                        <input className='search-input' type="text" placeholder='Tìm kiếm'
                            ...
                            onKeyDown={(e) => {
                                if (keySearch.length === 0) return
                                else {
                                    if (e.key === "Enter") {
                                        nav(`/search/${keySearch}`)
